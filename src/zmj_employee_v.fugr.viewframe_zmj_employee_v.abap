*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMJ_EMPLOYEE_V
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMJ_EMPLOYEE_V      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMJ_EMPLOYEE_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMJ_EMPLOYEE_V_EXTRACT
TOTAL = ZMJ_EMPLOYEE_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMJ_EMPLOYEE_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMJ_EMPLOYEE_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMJ_EMPLOYEE_V_EXTRACT
TOTAL = ZMJ_EMPLOYEE_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMJ_EMPLOYEE_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMJ_EMPLOYEE_V'
...
TOTAL = ZMJ_EMPLOYEE_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMJ_EMPLOYEE_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMJ_EMPLOYEE_V-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMJ_EMPLOYEE_V'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMJ_EMPLOYEE_V-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMJ_EMPLOYEE_V_EXTRACT
TOTAL = ZMJ_EMPLOYEE_V_TOTAL
